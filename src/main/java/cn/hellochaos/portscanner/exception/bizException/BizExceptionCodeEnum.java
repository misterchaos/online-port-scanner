...
/**
 * @Description : 异常消息的枚举类(此类属于业务异常枚举类) @Param : @Return : @Author : SheldonPeng @Date : 2019-10-11
 */
public enum BizExceptionCodeEnum implements BizExceptionCode {
  ...
  /** @Description : @Param : [code, message] @Return : @Author : SheldonPeng @Date : 2019-10-11 */
